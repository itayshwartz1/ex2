...
def calculate_fitness(decrypted_text, dictionary, letter_frequencies, letter_pair_frequencies):
    ...
    return num_of_hits, num_of_hits - sum_letter_freq - sum_pair_freq  + 100
...
def main():
    ...
    solved, decrypted_text = genetic_algorithm(ciphertext, dictionary, letter_frequencies, letter_pair_frequencies)
    end_time = time.time()
